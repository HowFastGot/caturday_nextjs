...
async function FavoritePage() {
	const rawResp = await fetch(
		'https://api.thecatapi.com/v1/favourites?sub_id=yevhen_sk&limit=5',
		{
			headers: {
	...
	const changedApiResponse = likedCatCarts.map(changeApiRespObj).reverse();

	return (
		<PageContainer>
			<BackArrow_Title title='Favorites' />
